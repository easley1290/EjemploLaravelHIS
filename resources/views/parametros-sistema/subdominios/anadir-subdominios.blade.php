            ...
            <div class="content">
                <div class="row clearfix col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="modal-title">AÑADIR SUBDOMINIO</h3>
                            </div>
                            <div class="body">
                            <form method="POST" action="{{ route('subdominios.store') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="textbox" id="anadir-descripcion-sdom" name="anadir-descripcion-sdom" class="form-control"
                                            onKeyPress="if(this.value.length==100) return false;"
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <select name="anadir-dominio-sdom" id="anadir-dominio-sdom"">
                                                        ...
                                                        <option value="">NINGUN DOMINIO</option>
                                    ...
                                    <div class="form-group">
                                        <div class="switch">
                                            <label>ACTIVO
                                                <input type="checkbox" id="anadir-estado-sdom" name="anadir-estado-sdom" class="filled-in" value="1"
