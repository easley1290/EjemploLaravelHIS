                ...
                <div class="row clearfix col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                            <form method="POST" action="{{ route('cotizante.update', Crypt::encrypt($cotEdit->cotID)) }}">
                                    {{ csrf_field() }}
                                    @method('patch')
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    value="{{ round($cotEdit->cotTotGan, 2) }}"required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="form-line">
                                            ...
                                            <div class="col-md-6">
                                                <label for="anadir-altadoc-cot">DOCUMENTO DE ALTA DE COTIZANTE</label>
                                                <div class="form-group">
                                                    <div class="form-line">
                                            ...
                                            <div class="form-group">
                                                <div class="form-line">
                                                    ...
                                                    <select class="form-control" id="anadir-estado-cot" name="anadir-estado-cot">
                                                        <option value="{{ $estadoCot->altTip }}">{{ $estadoCot->altTip }}</option>
                                                        <option value="" disabled></option>
                                                        @foreach($subdominiosAlta as $sa)
                                ...
                                <div class="row clearfix">
                                    <div class="form-line">
                                        ...
                                        <form action="{{ route('cotizante.darBaja', Crypt::encrypt($cotEdit->cotID)) }}" method="POST">
                                            @csrf
                                            <div class="col-md-6">
                                                <a href=""><button class="btn btn-block btn-info m-t-15 waves-effect"><i class="material-icons">delete</i>&nbsp;DAR DE BAJA</button><br></a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
