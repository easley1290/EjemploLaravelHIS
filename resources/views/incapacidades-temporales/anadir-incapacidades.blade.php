            ...
            <div class="content">
                <div class="row clearfix col-lg-12 col-md-12 col-xs-12 col-sm-12">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="modal-title">AÑADIR REGISTRO DE INCAPACIDAD TEMPORAL</h3>
                            </div>
                            <div class="body">
                                <form method="POST" action="{{ route('incTemporal.store') }}">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            class="form-control" placeholder="Añade el codigo de la incapacidad" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            class="form-control" placeholder="Añade el nombre de la incapacidad" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            onKeyPress="if(this.value.length==2) return false;"  placeholder="Desde que dia tendra validez esta incapacidad" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="form-line">
                                            ...
                                            onKeyPress="if(this.value.length==3) return false;"  placeholder="Añada solo el numero de porcentaje de subsidio" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="switch">
                                            <label>ACTIVO <input type="checkbox" id="anadir-estado-inc" name="anadir-estado-inc" class="filled-in" value="1"
